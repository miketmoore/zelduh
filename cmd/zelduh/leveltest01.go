...
func BuildRooms01(entityConfigPresetFnManager *zelduh.EntityConfigPresetFnManager, tileSize float64) zelduh.RoomByIDMap {
	...
	return zelduh.RoomByIDMap{
		...
		// 	entityConfigPresetFnManager.GetPreset(PresetNameEnemySkull)(zelduh.NewCoordinates(6, 6)),
